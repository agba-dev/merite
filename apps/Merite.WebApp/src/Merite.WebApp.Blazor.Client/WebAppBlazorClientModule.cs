...
using Merite.WebApp.Blazor.Client.Menus;
...
[DependsOn(typeof(MeriteWebAppDomainSharedModule))]
[DependsOn(typeof(MeriteSharedModule))]
public class WebAppBlazorClientModule : AbpModule
{
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add(MeriteNames.AdministrationApi);
            options.ProviderOptions.DefaultScopes.Add(MeriteNames.IdentityServiceApi);
            options.ProviderOptions.DefaultScopes.Add(MeriteNames.SaaSApi);
            options.ProviderOptions.DefaultScopes.Add(MeriteNames.WebAppApi);
        });
    }
