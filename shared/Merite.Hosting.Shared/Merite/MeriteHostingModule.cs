...
public class MeriteHostingModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            var cstr = configuration.GetConnectionString(MeriteNames.RabbitMq);
    ...
    )
    {
        context.Services.AddSingleton<IDistributedLockProvider>(sp =>
        {
            var connection = ConnectionMultiplexer.Connect(
                configuration.GetConnectionString(MeriteNames.Redis)!
            );
...
public static class HostingExtensions
{
    ...
    )
    {
        var dataProtectionBuilder = context
            ...
            .SetApplicationName(MeriteNames.Merite);
